...
export const SELLER_FALLBACK_SHORT_BODY = "My complete planning summary has been copied to my clipboard. I'll paste it below:"
...
export function SellerResults({ sections, answers, onStartOver, onEditAnswers }: Props) {
  ...
  async function handleShare() {
    ...
    const fallbackHref = buildMailtoHref('', SELLER_SHARE_TITLE, SELLER_FALLBACK_SHORT_BODY)
    try {
      await navigator.clipboard.writeText(text)
